...
if (isset($_POST['savedata'])) {
    ...
    $sql = "INSERT INTO `student_data`( `student_name`, `gurdian_name`, `contact`,`email`, `address`, `class`,`shift`, `radio_button`, `blood_group`, `division`) VALUES ('$student_name','$gurdian_name','$contact','$email','$address','$class','$shift','$radio_button','$blood_group','$division')";
...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="gurdian_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
...
<select name="shift" id="" class="form-control">
  ...
  <div class="mb-3">
    <input type="radio" id="age1" name="radio" value="male">Male
    <input type="radio" id="age1" name="radio" value="female">Female
    <input type="radio" id="age1" name="radio" value="others">others
  </div>
